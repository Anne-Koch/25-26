...
<a href="mailto:daniel.hammer@uni-ulm.de"><i class="fa fa-paper-plane fa-fw"></i>&nbsp; daniel.hammer@uni-ulm.de</a>
]
...
- Interaktive Vorlesung mit Übungsaufgaben
  ...
  - Mittwochs von 8:30 Uhr - 10:00 Uhr in H8
...
- Probeklausur am 20.05.2026 in der Vorlesung! (Anwesenheitspflicht da Vorleistung)
...
Bis zum 22. Mai werden Vorlesungen in Form von Präsenzvorlesungen, Lehrvideos, Tutorials und RTutor Problem Sets stattfinden.
...
## `RTutor` Problem Sets Fragestunde

Die Deadline der `RTutor` Problem Sets ist immer Montag 23:59 Uhr

**Unsere Hilfestellung:**

- Wir bieten jeden Montag eine Fragerunde zu dem aktuellen `RTutor` Problem Set an
- Diese Fragerunde wird online (via Zoom Raum in Moodle) stattfinden und geht von 14 - 15 Uhr. Alle Fragen sollen dort gestellt und geklärt werden
- Studierende, die bei der Abgabe weniger als 80% des `RTutor` Problem Sets bestanden haben, haben die Vorleistung nicht bestanden und können nicht an den Projekten teilnehmen
- Es wird kein "Nachreichen" oder eine "Nacharbeit" des `RTutor` Problem Sets geben. Weniger als 80% der Punkte pro Problem Set bedeutet automatisch, dass die Vorleistung nicht bestanden wurde
...
- Die Gruppenzusammensetzung gilt für **ein selbstständiges Projekt**, d.h. nach dem ersten selbstständigen Projekt gibt es neue Gruppen
...
Voraussetzung zur Teilnahme am 2. Teil des Projektkurses in diesem SoSe 26:
- Erster Teil des Projektkurses im WiSe 25/26 bestanden
...
- Auf Moodle gibt es wieder ein Diskussionforum, scheuen Sie sich nicht dort ihre Fragen zu stellen!
    ...
    - Wir haben einige Beispiele aufgearbeitet, wie Sie Fragen stellen können, auf die Sie schnell antworten erhalten. [Das Dokument finden Sie hier](https://projektkurs-data-science-ulm2526.netlify.app/tutorials/fragen-im-forum)
...
## Projekt 5: Wie beeinflussen Bonuszahlungen die Motivation im Arbeitsalltag?

--

In diesem Projekt widmen Sie sich der Frage:

.alert[Steigern unerwartete Bonuszahlungen die Arbeitsleistung, oder bewirken sie das Gegenteil?]

- Zur Beantwortung dieser Frage werten Sie Daten eines Feldexperiments aus Bogotá (Kolumbien) aus, in dem Arbeitnehmer unter kontrollierten Bedingungen unerwartete Bonuszahlungen erhielten.
- Sie analysieren Ihre Daten deskriptiv und grafisch.
- Sie schätzen den kausalen Effekt der Bonuszahlungen mit einem Difference-in-Differences Ansatz.
- Sie replizieren Ihre Ergebnisse mit Daten eines zweiten Experiments und reflektieren die externe Validität der Studie.


---

## Projekt 6: Was verrät die Sprache von Stellenanzeigen über den Arbeitsmarkt?

--

In diesem Projekt widmen Sie sich der Frage:

.alert[Welche Kompetenzen sucht der deutsche Arbeitsmarkt und wie lassen sich Anforderungsprofile aus Stellenanzeigen systematisch mit KI auswerten?]

- Zur Beantwortung dieser Frage nutzen Sie die API der Bundesagentur für Arbeit, um Stellenanzeigen programmatisch zu erheben.
- Sie setzen eine LLM-API ein, um aus unstrukturiertem Text systematisch Anforderungen, Erfahrungslevel und Digitalisierungskompetenzen zu extrahieren.
- Sie entwickeln Ihren Prompt iterativ weiter und validieren die Klassifikationsqualität empirisch.
...
**Vorleistung 1:** Die **RTutor Problem Sets** müssen **individuell** bearbeitet und eingereicht werden um für die Projekte und Klausur zugelassen zu werden
  - Letztes RTutor Problem Set ist am 4. Mai fällig
  - Mindestens 80% der Punkte **pro Problem Set** müssen erreicht werden um für die Projekte zugelassen zu werden

--

**Vorleistung 2:** **Probeklausur** und die **Peer Reviews** müssen **individuell** bearbeitet und eingereicht werden um für die Klausur zugelassen zu werden
  - Mindestens 20% der Punkte in der **Probeklausur am 20.05.2026**
  - Letzter Review Report ist am 9. Juli fällig
...
.instructions[
Wir werden weiterhin unsere [private Organisation auf Github](https://github.com/pkds25-26) nutzen.
]

Falls Sie ihre Git-Kenntnisse auffrischen wollen können Sie jederzeit auf den [Moodle-Kurs des letzten Semesters](https://moodle.uni-ulm.de/mod/url/view.php?id=1007528) zugreifen. Die Unterlagen bleiben dort weiterhin für Sie verfügbar!
